...
{ 
	public class TentDeed : Item 
	{
		...
		{ 
			Name = "una tienda de campaña enrollada"; 
			Hue = 277; 
			Weight = 25.0; 
		...
		{ 
			...
			{
				from.SendMessage("Usted ya ha establecido el número máximo de tiendas de campaña.");
			}
			else
			{
				...
				{              
					...
					{
						from.SendMessage("No se puede construir su tienda de campaña en el campo.");
					}
				}
				else
				{
