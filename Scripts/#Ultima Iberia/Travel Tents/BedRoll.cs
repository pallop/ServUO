	...
	{ 
		...
		{ 
			if (m_Player==from)
			{
				...
				{
					from.SendMessage( "Du musst die Gegenstaende aus deiner Reisetasche entfernen, bevor du das Zelt abbaust." );
				} 
				else 
				{ 
			...
			{ 
				from.SendMessage( "Das Zelt gehoert dir nicht." ); 
			} 
		} 
